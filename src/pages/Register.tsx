      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Join AutoTradeLK and start trading vehicles
          </p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={handleInputChange}
                className="appearance-none relative block w-full px-3 py-3 border border-gray-300 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
              >
                <option value="buyer">Buy vehicles</option>
                <option value="seller">Sell vehicles</option>
                <option value="both">Buy and sell vehicles</option>
                <option value="leasing">Provide leasing services</option>
              </select>
            </div>
