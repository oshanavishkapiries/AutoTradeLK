  ...
  const vehicles = [
    {
      ...
      condition: "Used",
      description:
        "Excellent condition, well maintained vehicle with full service records.",
    },
    {
      id: 2,
      image:
      ...
      condition: "Used",
      description:
        "Sporty and reliable. Perfect for city driving and long trips.",
    },
    {
      id: 3,
      image:
    ...
    },
    {
      id: 4,
      image:
        "https://images.pexels.com/photos/1719649/pexels-photo-1719649.jpeg?auto=compress&cs=tinysrgb&w=600",
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-4">
            ...
            <Link
              ...
              className="bg-accent-500 text-white px-6 py-3 rounded-lg hover:bg-accent-600 transition-colors flex items-center space-x-2"
            >
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div
            className={`lg:w-80 ${
              showFilters || window.innerWidth >= 1024 ? "block" : "hidden"
            }`}
          >
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex space-x-2">
                        ...
                        <Link
                          to="/vehicle-comparison"
                          className="bg-accent-500 text-white px-3 py-2 rounded-lg hover:bg-accent-600 transition-colors flex items-center justify-center"
